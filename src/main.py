...
## x_em、egde_h、group_number、gnn_layer
...
def test(model, history_list, test_list, num_rels, num_nodes, use_cuda, all_ans_list, all_ans_r_list, model_name, static_graph, mode):
    ...
    for time_idx, test_snap in enumerate(tqdm(test_list)):
        ...
        test_triples, final_score, final_r_score = model.predict(history_glist, num_rels, static_graph, test_triples_input, use_cuda, num_nodes, input_list)
    ...
    if args.test and os.path.exists(model_state_file):
        ...
        for epoch in range(args.n_epochs):
            ...
            for train_sample_num in tqdm(idx):
                ...
                loss_e, loss_r, loss_static = model.get_loss(history_glist, output[0], static_graph, use_cuda, num_nodes, input_list)
...
#    parser.add_argument("--n-epochs", type=int, default=500,
    ...
    parser.add_argument('--lgroup_num', type=int, default=10, help='')
    ...
    if args.grid_search:
        ...
        for i, grid_entry in enumerate(list(grid)):
            ...
            for hit in hits:
                ...
                # result_dic["hits_{0}".format(str(hit))] = avg_count.item()
